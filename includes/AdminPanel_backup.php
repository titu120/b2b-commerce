<?php
    ...
    class AdminPanel
    {
        ...
        public function add_admin_menu()
        {
            ...
            add_submenu_page(
                'b2b-dashboard',
                __('Product Inquiries', 'b2b-commerce'),
                __('Product Inquiries', 'b2b-commerce'),
                'manage_options',
                'b2b-inquiries',
                [$this, 'inquiries_page']
        ...
        public function render_admin_wrapper($current_page, $content)
        {
            ...
            $menu_items = [
                ...
                'b2b-quotes'            => [__('Quotes', 'b2b-commerce'), 'dashicons-email-alt', $pending_quotes],
                'b2b-inquiries'         => [__('Product Inquiries', 'b2b-commerce'), 'dashicons-format-chat', $pending_inquiries],
